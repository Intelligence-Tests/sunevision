...
import imgSrc1 from "../assets/photos/customdesign/customdesign1.jpeg";
import imgSrc2 from "../assets/photos/customdesign/customdesign2.jpeg";
import imgSrc3 from "../assets/photos/customdesign/customdesign3.jpeg";
import imgSrc4 from "../assets/photos/customdesign/customdesign4.jpeg";
...
const ExploreSix = () => {
    ...
    return (
        <Section className="overflow-hidden" id="exploremorecustom">
            <ScrollToTop />
            <WhatsappFeature/>
                ...
                <div className="relative h-64 bg-gray-900">
                    ...
                    <div className="absolute inset-0 bg-black bg-opacity-40">
                        <div className="container mx-auto px-6 h-full flex flex-col justify-center animate-slide-text items-center">
                            <h1 className="text-white text-3xl md:text-4xl font-bold mb-4">Custom Design plan</h1>
            ...
            <div className="max-w-5xl mx-auto mb-20 px-4 text-center md:text-left md:ml-[80px]">
                ...
                <ul className="space-y-4">
                    {[
                        "Tailored Solutions: Designs personalized to your preferences.",
                        "Collaborative Approach: Working closely to bring your vision to life.",
                        "Expert Space Planning: Ensuring maximum efficiency and flow.",
                        "Versatile Styles: From traditional to modern aesthetics.",
                        "Attention to Detail: Meticulous execution for flawless results."
                    ].map((text, index) => (
