...
import imgSrc1 from "../assets/photos/modularkitchen/kitchen1.jpg";
import imgSrc2 from "../assets/photos/modularkitchen/kitchen2.jpg";
import imgSrc3 from "../assets/photos/modularkitchen/kitchen3.jpg";
import imgSrc4 from "../assets/photos/modularkitchen/kitchen4.jpg";
...
const ExploreFive = () => {
    ...
    return (
        <Section className="overflow-hidden" id="exploremorekitchen">
            <ScrollToTop />
            <WhatsappFeature/>
                ...
                <div className="relative h-64 bg-gray-900">
                    ...
                    <div className="absolute inset-0 bg-black bg-opacity-40">
                        <div className="container mx-auto px-6 h-full flex flex-col justify-center animate-slide-text items-center">
                            <h1 className="text-white text-3xl md:text-4xl font-bold mb-4">Modular Kitchen Design</h1>
            ...
            <div className="max-w-5xl mx-auto mb-20 px-4 text-center md:text-left md:ml-[80px]">
                ...
                <ul className="space-y-4">
                    {[
                        "Innovative Storage Solutions: Maximizing space with smart designs.",
                        "Ergonomic Layouts: Ensuring seamless functionality and flow.",
                        "Premium Finishes: High-quality materials for a sleek look.",
                        "Custom Configurations: Tailored to fit your unique needs.",
                        "Modern Appliances Integration: Designed for contemporary living."
                    ].map((text, index) => (
            ...
            <div className="max-w-5xl mx-auto mb-20 px-4 text-center md:text-left md:ml-[80px]">
                ...
                <p className="text-lg leading-relaxed">
                    We design modular kitchens that blend efficiency, style, and practicality, turning the heart of your home into a masterpiece. By focusing on ergonomic layouts and innovative storage solutions, we create spaces that enhance functionality while maintaining visual appeal. From selecting durable materials to incorporating state-of-the-art appliances, every detail is crafted with care. Let us help you create a kitchen that not only meets your culinary needs but also elevates your home’s overall design.
                </p>
            </div>
