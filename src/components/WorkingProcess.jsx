...
const WorkingProcess = () => (
  <Section className="overflow-hidden" id="roadmap">
    <div className="container mx-auto md:pb-10 px-4">
      {/* Heading */}
      {/* <Heading tag="h2" title="Our Latest Projects and Designs" /> */}

      {/* Contact Us Section */}
      <div className="flex flex-col md:flex-row justify-between items-center md:items-start text-center md:text-left pt-8 space-y-12 md:space-y-0 md:space-x-12">

        {/* Get in Touch Form */}
        <div className="flex flex-col items-center md:items-start w-full md:w-[45%] ml-8">
          <h2 className="text-3xl font-semibold mb-6">Get in touch with us</h2>
          <div className="flex justify-center md:justify-start items-center space-x-4 mb-6 w-full">
            <input
              type="email"
        ...
        {/* Contact Information */}
        <div className="flex flex-col md:flex-row justify-center md:justify-start items-center md:items-start w-full md:w-[45%] space-y-8 md:space-y-0 md:space-x-12">
