...
import imgSrc1 from "../assets/photos/2d3ddesign/3dphoto1.jpeg";
import imgSrc2 from "../assets/photos/2d3ddesign/3dphoto2.jpeg";
import imgSrc3 from "../assets/photos/2d3ddesign/3dphoto3.jpeg";
import imgSrc4 from "../assets/photos/2d3ddesign/3dphoto4.jpeg";
...
const ExploreThree = () => {
    ...
    return (
        <Section className="overflow-hidden" id="exploremore3ddesign">
            <ScrollToTop />
            <WhatsappFeature/>
                ...
                <div className="relative h-64 bg-gray-900">
                    ...
                    <div className="absolute inset-0 bg-black bg-opacity-40">
                        <div className="container mx-auto px-6 h-full flex flex-col justify-center animate-slide-text items-center">
                            <h1 className="text-white text-3xl md:text-4xl font-bold mb-4">2D/3D Design Layout</h1>
            ...
            <div className="max-w-5xl mx-auto mb-20 px-4 text-center md:text-left md:ml-[80px]">
                ...
                <ul className="space-y-4">
                    {[
                        "Precision Planning: Accurate layouts tailored to your requirements.",
                        "Realistic 3D Visuals: Bringing your ideas to life in vivid detail.",
                        "Comprehensive Detailing: Ensuring every element is thoughtfully placed.",
                        "Seamless Revisions: Adapting designs to meet your evolving needs.",
                        "Interactive Presentations: Immersive layouts for better understanding."
                    ].map((text, index) => (
            ...
            <div className="max-w-5xl mx-auto mb-20 px-4 text-center md:text-left md:ml-[80px]">
                ...
                <p className="text-lg leading-relaxed">
                    We focus on creating detailed 2D and 3D layouts that seamlessly combine functionality with artistic flair. Our process starts with understanding your vision and translating it into precise floor plans and realistic visualizations. By leveraging advanced design tools, we ensure every detail is captured, offering a clear representation of your space before execution. Whether refining layouts or visualizing complex ideas, we prioritize clarity, accuracy, and collaboration to turn concepts into inspiring spaces.        </p>
            </div>
