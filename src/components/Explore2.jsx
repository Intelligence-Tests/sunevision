    ...
    <Section className="overflow-hidden" id="exploremoreexterior">
        ...
        <div className="relative h-64 bg-gray-900">
          ...
          <div className="absolute inset-0 bg-black bg-opacity-40">
            <div className="container mx-auto px-6 h-full flex flex-col justify-center animate-slide-text items-center">
              <h1 className="text-white text-3xl md:text-4xl font-bold mb-4">Home Exterior Design</h1>
      ...
      <div className="max-w-5xl mx-auto mb-20 px-4 text-center md:text-left md:ml-[80px]">
        ...
        <ul className="space-y-4">
          {[
            "Personalized Facades: Exterior designs crafted to match your vision.",
            "Durable Construction: Built to withstand time and weather effortlessly.",
            "Harmonized Aesthetics: Seamless integration of form and function.",
            "Eco-Friendly Options: Sustainable materials for a greener future.",
            "Versatile Styles: From classic charm to contemporary sophistication."
          ].map((text, index) => (
      ...
      <div className="max-w-5xl mx-auto mb-20 px-4 text-center md:text-left md:ml-[80px]">
        ...
        We specialize in transforming your home’s exterior into a masterpiece that captures your unique style and enhances its curb appeal. By blending innovative design with timeless elegance, we create facades that are as functional as they are beautiful. From selecting premium materials to ensuring flawless execution, every detail is carefully considered to deliver stunning results. Whether it’s a modern refresh or a classic update, we bring your vision to life, elevating your home’s exterior to a whole new level of sophistication.        </p>
      </div>
